...
| 2024 Revenue & Operating Profit | Forbes, ["Formula 1's Most Valuable Teams 2025"](https://www.forbes.com/sites/brettknight/2025/11/20/formula-1s-most-valuable-teams-2025/) (published Nov 20, 2025) |
...
- Dashboard: vanilla HTML/CSS/JS + [Chart.js](https://www.chartjs.org/) for the bubble and bar charts, hosted on GitHub Pages.
- Model: Excel (openpyxl-built), fully formula-driven — every derived metric recalculates if the raw inputs change.

## Author

Yash Desai — [LinkedIn](#) · [GitHub](https://github.com/yashdesai241me320-max)
